...
const styles = StyleSheet.create({
  ...
  title: {
    color: theme.color.brand, fontSize: 10, fontWeight: "900", letterSpacing: 1.5,
  ...
  primaryBtnT: { color: "#fff", fontSize: 10, fontWeight: "900", letterSpacing: 1, fontFamily: theme.font.textSemi },
  ...
  secondaryBtnT: { color: theme.color.brand, fontSize: 10, fontWeight: "900", letterSpacing: 1, fontFamily: theme.font.textSemi },
  ...
  mutedBtnT: { color: theme.color.textMuted, fontSize: 10, fontWeight: "900", letterSpacing: 1, fontFamily: theme.font.textSemi },
});
