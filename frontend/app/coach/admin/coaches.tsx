...
const styles = StyleSheet.create({
  ...
  tierPillText: { fontSize: 11, fontWeight: "800", letterSpacing: 1 },
  metaRow: { flexDirection: "row", gap: 8, marginTop: 8 },
  metaChip: { color: theme.color.textMuted, fontSize: 11, fontWeight: "800", letterSpacing: 1, borderWidth: 1, borderColor: theme.color.border, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  ...
  actionGhostText: { color: theme.color.text, fontWeight: "800", letterSpacing: 1, fontSize: 11 },
