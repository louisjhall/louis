...
const styles = StyleSheet.create({
  ...
  chipT: { color: theme.color.text, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  chipTOn: { color: "#fff" },
  ...
  week: { color: theme.color.textMuted, fontSize: 11, marginTop: 3, letterSpacing: 1 },
  tagRow: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 10 },
  tag: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 4, borderWidth: 1 },
  tagT: { fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  pill: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 12, borderWidth: 1 },
  pillT: { fontSize: 11, fontWeight: "900", letterSpacing: 1.2 },
