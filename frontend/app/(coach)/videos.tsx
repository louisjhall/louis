...
const styles = StyleSheet.create({
  ...
  itemMeta: { color: theme.color.textDim, fontSize: 9, fontWeight: "800", letterSpacing: 1 },
  badge: {
    color: theme.color.brand, fontSize: 8, fontWeight: "800", letterSpacing: 1,
  ...
  preferredBadge: { color: "#fff", fontSize: 9, fontWeight: "800", letterSpacing: 1, paddingHorizontal: 6, paddingVertical: 2, backgroundColor: theme.color.brand, borderRadius: 3, marginLeft: "auto" },
  comingSoon: { color: theme.color.textDim, fontSize: 9, fontWeight: "800", letterSpacing: 1, marginLeft: "auto" },
  ...
  actBtnText: { color: "#fff", fontSize: 10, fontWeight: "800", letterSpacing: 1 },
  ...
  btnGhostText: { color: theme.color.brand, fontSize: 10, fontWeight: "800", letterSpacing: 1.5 },
