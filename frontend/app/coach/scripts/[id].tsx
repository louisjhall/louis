...
const styles = StyleSheet.create({
  ...
  est: { color: theme.color.brand, fontWeight: "700", fontSize: 11 },
  ...
  softBtnText: { color: theme.color.brand, fontSize: 11, letterSpacing: 1, fontWeight: "800" },
  ...
  prevDate: { color: theme.color.textDim, fontSize: 11, letterSpacing: 1, fontWeight: "700" },
