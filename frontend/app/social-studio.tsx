...
const styles = StyleSheet.create({
  ...
  platformTag: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  postType: { color: theme.color.textDim, fontSize: 11, fontWeight: "800", letterSpacing: 1 },
  ...
  postPillar: { color: theme.color.textMuted, fontSize: 11, marginTop: 4, letterSpacing: 0.5 },
  ...
  backChipT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  sect: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 2, marginTop: 16, marginBottom: 4 },
  ...
  toneT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
