...
export const REALITY_KINDS: Kind[] = [
  { key: "exhausted", label: "I'm exhausted", emoji: "😴", icon: "moon", hint: "Little sleep, low energy" },
  { key: "flight_delayed", label: "Flight delayed", emoji: "✈️", icon: "airplane", hint: "Delay disrupts today" },
  { key: "roster_changed", label: "Roster changed", emoji: "📅", icon: "calendar", hint: "Duties shifted" },
  { key: "hotel_changed", label: "Hotel changed", emoji: "🏨", icon: "business", hint: "Different equipment" },
  { key: "no_gym", label: "No gym available", emoji: "🏋️", icon: "barbell", hint: "Bodyweight only" },
  { key: "feeling_amazing", label: "Feeling amazing", emoji: "💪", icon: "flame", hint: "Add bonus quality" },
  { key: "less_time", label: "Less time today", emoji: "⏰", icon: "hourglass", hint: "Squeeze it in" },
  { key: "more_time", label: "More time today", emoji: "🕒", icon: "time", hint: "Extra window" },
  { key: "family_commitments", label: "Family commitments", emoji: "👶", icon: "people", hint: "Family first" },
  { key: "annual_leave", label: "Annual leave", emoji: "🏖️", icon: "sunny", hint: "Rest or travel" },
  { key: "feeling_ill", label: "Feeling ill", emoji: "🤒", icon: "medkit", hint: "Illness" },
  { key: "injured", label: "Injured", emoji: "🤕", icon: "bandage", hint: "Injury flag" },
  { key: "travelling", label: "Travelling", emoji: "🚗", icon: "car", hint: "On the move" },
  { key: "bad_weather", label: "Bad weather", emoji: "🌧️", icon: "rainy", hint: "Storms / heat" },
  { key: "missed_yesterday", label: "Missed yesterday", emoji: "❌", icon: "close-circle", hint: "Recover safely" },
  { key: "want_to_move", label: "Move this workout", emoji: "🔁", icon: "swap-horizontal", hint: "Reschedule" },
  { key: "other", label: "Something else", emoji: "📝", icon: "create", hint: "Tell CrewFit" },
];
