...
const META: Record<WorkoutStatus, { label: string; desc: string; color: string; icon: any }> = {
  coach_reviewing: { label: "COACH REVIEWING", desc: "Your coach is reviewing this workout before it becomes available.", color: "#F59E0B", icon: "eye" },
  ...
  locked:          { label: "LOCKED",          desc: "This workout has been locked by your coach.",                       color: "#6B7280",         icon: "lock-closed" },
};
