...
const styles = StyleSheet.create({
  ...
  sbBtnT: { color: theme.color.text, fontSize: 11, fontWeight: "800", letterSpacing: 0.5, flexShrink: 1 },
  ...
  appliedHead: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  restoreT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  recDur: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1, marginTop: 4 },
});
