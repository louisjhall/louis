...
const styles = StyleSheet.create({
  ...
  buildingTitle: { color: theme.color.textDim, fontSize: 11, letterSpacing: 1.5, fontWeight: "800", flex: 1 },
  buildingSlow: { color: "#f5b543", fontSize: 11, fontStyle: "italic" },
  buildStages: { flexDirection: "row", alignItems: "center", gap: 4 },
  buildStage: { flexDirection: "row", alignItems: "center", gap: 4 },
  buildLabel: { color: theme.color.textHi, fontSize: 11, fontWeight: "700" },
  ...
  pillTextDim:   { color: theme.color.textDim, fontSize: 11, letterSpacing: 1.4, fontWeight: "800" },
  pillTextGreen: { color: "#61c982", fontSize: 11, letterSpacing: 1.4, fontWeight: "800" },
  pillTextAmber: { color: "#f5b543", fontSize: 11, letterSpacing: 1.4, fontWeight: "800" },
  pillTextBlue:  { color: "#5aa9e6", fontSize: 11, letterSpacing: 1.4, fontWeight: "800" },
  pillHint:      { color: theme.color.textDim, fontSize: 11, marginLeft: 4 },
  pillHintTight: { color: theme.color.textDim, fontSize: 11, marginLeft: 4 },
});
