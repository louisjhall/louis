...
const styles = StyleSheet.create({
  ...
  dayHeadTotal: { color: theme.color.textMuted, fontSize: 10, letterSpacing: 1.5, fontWeight: "800" },
  ...
  cardMeta: { color: theme.color.textMuted, fontSize: 10, letterSpacing: 1, marginTop: 2, fontWeight: "700" },
  ...
  macroPillT: { color: theme.color.text, fontSize: 10, fontWeight: "800" },
