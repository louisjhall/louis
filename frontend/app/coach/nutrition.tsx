...
const styles = StyleSheet.create({
  ...
  noteInput: { flex: 1, minHeight: 60, color: theme.color.onRed, backgroundColor: theme.color.surface2, borderRadius: 8, padding: 10, borderWidth: 1, borderColor: theme.color.border, fontSize: 13 },
  ...
  input: { color: theme.color.onRed, backgroundColor: theme.color.surface2, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, borderWidth: 1, borderColor: theme.color.border, marginTop: 4 },
