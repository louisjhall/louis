...
function categoryOf(t: Task): string {
  ...
  if (t.task_type === "workout_review") return "programme";
...
export function CoachToDoFeed() {
  ...
  const open = (t: Task) => {
    ...
    if (t.task_type === "workout_review") {
      const wid = (t as any).workout_id;
      if (wid) {
        router.push(`/coach/workout/edit/${wid}` as any);
        return;
      }
      const cid = (t as any).client_id || (t as any).user_id;
...
const styles = StyleSheet.create({
  ...
  catLabel: { fontSize: 11, fontWeight: "900", letterSpacing: 2 },
  catCount: { color: theme.color.textDim, fontSize: 11, fontWeight: "800" },
  ...
  taskType: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  urgent: { backgroundColor: "#c94a4a", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3 },
  urgentT: { color: "#fff", fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  riskHigh: { backgroundColor: "#c94a4a", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3 },
  riskHighT: { color: "#fff", fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  riskMed: { backgroundColor: theme.color.amber, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3 },
  riskMedT: { color: "#000", fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  meta: { color: theme.color.textDim, fontSize: 11, marginTop: 4, letterSpacing: 1 },
});
