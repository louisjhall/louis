...
const styles = StyleSheet.create({
  ...
  exFieldLbl: { color: theme.color.textMuted, fontSize: 9, fontWeight: "700", letterSpacing: 0.6, marginBottom: 3, textAlign: "center" },
  ...
  pillT: { color: theme.color.text, fontSize: 10, fontWeight: "800", letterSpacing: 0.8 },
  ...
  diffLbl: { color: theme.color.textMuted, fontSize: 9, letterSpacing: 1, fontWeight: "800" },
  ...
  resTags: { color: theme.color.brand, fontSize: 10, marginTop: 2, letterSpacing: 0.5 },
});
