...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: theme.color.textDim, fontSize: 11, letterSpacing: 1.4, fontWeight: "800" },
  ...
  section: { color: theme.color.textDim, fontSize: 11, letterSpacing: 1.6, fontWeight: "800", marginBottom: 8 },
  ...
  assignLabel: { color: theme.color.textDim, fontSize: 11, letterSpacing: 1.3, fontWeight: "800" },
  ...
  dupeIdMono: { color: theme.color.textDim, fontSize: 11, fontFamily: "monospace", marginTop: 2 },
  pillKeep: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, backgroundColor: "rgba(80, 200, 120, 0.2)" },
  pillKeepText: { color: "#50c878", fontSize: 11, fontWeight: "800", letterSpacing: 1 },
});
