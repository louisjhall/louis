...
const styles = StyleSheet.create({
  ...
  sectLabel: { color: theme.color.brand, fontSize: 11, letterSpacing: 2, marginBottom: theme.space.xs, fontWeight: "800" },
  ...
  label: { color: theme.color.textMuted, fontSize: 11, letterSpacing: 1.5, marginBottom: 4, fontWeight: "700" },
