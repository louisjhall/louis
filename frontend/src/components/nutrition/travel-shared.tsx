...
export const travelStyles = StyleSheet.create({
  section: { color: theme.color.brand, fontSize: 10, letterSpacing: 2, fontWeight: "900", marginTop: 6, fontFamily: theme.font.textSemi },
  ...
  disclaimer: { color: theme.color.textDim, fontSize: 10, textAlign: "center", fontStyle: "italic", lineHeight: 15, paddingHorizontal: 8, marginTop: 6 },
});
...
const styles = StyleSheet.create({
  ...
  headerSub: { color: theme.color.textMuted, fontSize: 10, letterSpacing: 1.5, marginTop: 2 },
  ...
  ribbonT: { color: theme.color.brand, fontSize: 9, fontWeight: "900", letterSpacing: 0.5 },
  ...
  rHeadT: { color: theme.color.brand, fontSize: 10, letterSpacing: 2, fontWeight: "900", flex: 1 },
  confPill: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  confT: { color: "#fff", fontSize: 8, fontWeight: "900", letterSpacing: 0.7 },
  ...
  lHeadT: { fontSize: 10, letterSpacing: 2, fontWeight: "900" },
