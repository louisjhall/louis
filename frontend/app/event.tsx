...
const styles = StyleSheet.create({
  ...
  countLbl: { color: theme.color.brand, fontSize: 11, letterSpacing: 1.5, fontWeight: "800" },
  ...
  countBigLbl: { color: theme.color.textMuted, fontSize: 11, letterSpacing: 1.5, fontWeight: "800" },
  phasePill: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: theme.radius.sm, marginTop: 6 },
  phaseText: { color: "#fff", fontSize: 11, letterSpacing: 1.5, fontWeight: "800" },
  ...
  sectLabel: { color: theme.color.brand, fontSize: 11, letterSpacing: 2, fontWeight: "800", marginBottom: 4 },
  ...
  miniLabel: { color: theme.color.textMuted, fontSize: 11, letterSpacing: 1.5, fontWeight: "700", marginBottom: 4, marginTop: 8 },
