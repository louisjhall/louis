...
const styles = StyleSheet.create({
  ...
  actionBadgeT: { color: "#fff", fontSize: 9, fontWeight: "900", letterSpacing: 1 },
  weekT: { color: theme.color.textMuted, fontSize: 10, letterSpacing: 1.5, fontWeight: "800" },
  ...
  blockLabel: { color: theme.color.textMuted, fontSize: 9, letterSpacing: 1.5, fontWeight: "900" },
  ...
  tcsPending: { color: theme.color.brand, fontSize: 10, marginTop: 4, letterSpacing: 0.5, fontWeight: "800" },
  ...
  statLabel: { color: theme.color.textDim, fontSize: 8, letterSpacing: 1, fontWeight: "900" },
  ...
  historyDate: { color: theme.color.textMuted, fontSize: 10, letterSpacing: 1, fontWeight: "800" },
  ...
  statusPillT: { color: theme.color.textMuted, fontSize: 8, letterSpacing: 0.8, fontWeight: "900" },

  disclaimer: { color: theme.color.textDim, fontSize: 10, textAlign: "center", fontStyle: "italic", lineHeight: 15, paddingHorizontal: 6, marginTop: 6 },
});
