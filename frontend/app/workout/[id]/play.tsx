...
const styles = StyleSheet.create({
  ...
  wMeta: { color: theme.color.textDim, fontSize: 11, marginTop: 2, fontWeight: "700" },
  progressCircle: {
    width: 40, height: 40, borderRadius: 20,
    backgroundColor: theme.color.brandTint, borderWidth: 2, borderColor: theme.color.brand,
    alignItems: "center", justifyContent: "center",
  },
  progressT: { color: theme.color.brand, fontSize: 11, fontWeight: "900" },
  ...
  exCounter: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 2, paddingHorizontal: 16, paddingTop: 8 },
  ...
  restBtnT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  howHead: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 2, marginBottom: 10 },
  ...
  howNumT: { color: theme.color.brand, fontSize: 11, fontWeight: "900" },
  ...
  coachBadgeT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  atlasRecoLbl: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  eqChipT: { color: theme.color.textMuted, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  suggestedT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  setActiveT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  navT: { color: theme.color.text, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  warmupBannerT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  warmupBannerS: { color: theme.color.text, fontSize: 11, marginTop: 2, fontWeight: "600" },

  cardioHint: { color: theme.color.textMuted, fontSize: 11, marginTop: 8, textAlign: "center", fontStyle: "italic" },
  progReason: { color: theme.color.textMuted, fontSize: 11, marginTop: 6, lineHeight: 14, fontStyle: "italic" },
  ...
  wuEyebrow: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 2 },
  ...
  wuMeta: { color: theme.color.textMuted, fontSize: 11, marginTop: 2, fontWeight: "700", letterSpacing: 1 },
  ...
  wuBtnT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  wuBtnGhost: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: theme.color.border },
  wuBtnGhostT: { color: theme.color.textMuted, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  wuBlockH: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5, marginBottom: 6 },
