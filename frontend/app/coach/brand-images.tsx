...
const styles = StyleSheet.create({
  ...
  headerT: { color: theme.color.brand, fontSize: 11, letterSpacing: 2, fontWeight: "900", fontFamily: theme.font.textSemi },
  ...
  placeholderT: { color: theme.color.textDim, fontSize: 11, letterSpacing: 2, fontWeight: "900" },

  statusPill: { position: "absolute", top: 10, left: 10, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12 },
  statusPillT: { color: "#fff", fontSize: 11, letterSpacing: 1, fontWeight: "900" },
  ...
  defaultPillT: { color: "#fff", fontSize: 11, letterSpacing: 1, fontWeight: "900" },
  ...
  metaCat: { color: theme.color.brand, fontSize: 11, letterSpacing: 1.5, fontWeight: "900", fontFamily: theme.font.textSemi },
  ...
  ctxChipT: { color: theme.color.textMuted, fontSize: 11, fontWeight: "700" },
  errorT: { color: "#f39a9a", fontSize: 11, fontStyle: "italic" },
  metaSize: { color: theme.color.textDim, fontSize: 11, letterSpacing: 0.5, marginTop: 2 },
  ...
  actionBtnT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  ...
  actionBtnMutedT: { color: theme.color.textMuted, fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  approvalHeader: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 8 },
  approvalHeaderT: { color: theme.color.amber, fontSize: 11, fontWeight: "900", letterSpacing: 2, fontFamily: theme.font.textSemi },
});
