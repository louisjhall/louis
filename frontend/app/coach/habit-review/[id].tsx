...
const styles = StyleSheet.create({
  ...
  summaryHead: { color: theme.color.brand, fontSize: 9, fontWeight: "900", letterSpacing: 2 },
  ...
  blockHead: { color: theme.color.textDim, fontSize: 9, fontWeight: "900", letterSpacing: 2 },
  ...
  recAction: { color: theme.color.brand, fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  recRisk: { color: theme.color.textDim, fontSize: 9, fontWeight: "800", letterSpacing: 1 },
