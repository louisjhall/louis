...
const styles = StyleSheet.create({
  ...
  emptyBadge: { color: theme.color.textMuted, fontSize: 11, fontWeight: "800", letterSpacing: 1.5 },
  weekdayRow: { flexDirection: "row", marginBottom: 4 },
  weekday: { flex: 1, textAlign: "center", color: theme.color.textDim, fontSize: 11, fontWeight: "800", letterSpacing: 1 },
  ...
  historySub: { color: theme.color.textMuted, fontSize: 11, marginTop: 2, letterSpacing: 0.5 },
  fab: {
