...
const styles = StyleSheet.create({
  ...
  input: { color: theme.color.onRed, fontFamily: theme.font.text, fontSize: 16, backgroundColor: theme.color.surface2, borderRadius: 8, padding: 12, borderWidth: 1, borderColor: theme.color.border },
  textarea: { color: theme.color.onRed, fontFamily: theme.font.text, fontSize: 14, backgroundColor: theme.color.surface2, borderRadius: 8, padding: 12, borderWidth: 1, borderColor: theme.color.border, minHeight: 80, textAlignVertical: "top" },
