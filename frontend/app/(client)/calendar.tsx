...
const styles = StyleSheet.create({
  ...
  monthChipText: { color: theme.color.textMuted, fontSize: 10, fontWeight: "800", letterSpacing: 1 },
  ...
  monthLabel: { color: theme.color.text, fontSize: 14, fontWeight: "800", letterSpacing: 1 },
  emptyBadge: { color: theme.color.textMuted, fontSize: 9, fontWeight: "800", letterSpacing: 1.5 },
  weekdayRow: { flexDirection: "row", marginBottom: 4 },
  weekday: { flex: 1, textAlign: "center", color: theme.color.textDim, fontSize: 10, fontWeight: "800", letterSpacing: 1 },
