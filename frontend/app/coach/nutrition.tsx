...
const styles = StyleSheet.create({
  ...
  cardGoalT: { color: theme.color.brand, fontSize: 9, letterSpacing: 1, fontWeight: "900" },
  cardRow: { flexDirection: "row", gap: 8 },
  statK: { color: theme.color.textDim, fontSize: 9, letterSpacing: 1.3, fontWeight: "900" },
  ...
  badgeT: { color: "#fff", fontSize: 8, letterSpacing: 0.7, fontWeight: "900" },
  ...
  detailK: { color: theme.color.textMuted, fontSize: 9, letterSpacing: 1.5, fontWeight: "900" },
  ...
  logMeta: { color: theme.color.textMuted, fontSize: 10, marginTop: 2, letterSpacing: 0.5 },
  ...
  noteMeta: { color: theme.color.textDim, fontSize: 10, marginTop: 6 },
  ...
  noteBtnT: { color: "#fff", fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  ...
  label: { color: theme.color.brand, fontSize: 10, letterSpacing: 2, fontWeight: "900", marginTop: 4, fontFamily: theme.font.textSemi },
  ...
  chipTOn: { color: "#fff" },
  safety: { color: theme.color.textDim, fontSize: 10, marginTop: 8, fontStyle: "italic", lineHeight: 15 },
