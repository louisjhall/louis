...
const styles = StyleSheet.create({
  ...
  cardLabel: { color: theme.color.textDim, fontSize: 11, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 },
  ...
  dateBtnMeta: { color: theme.color.textDim, fontSize: 11, marginTop: 2 },
