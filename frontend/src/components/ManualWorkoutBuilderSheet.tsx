...
const styles = StyleSheet.create({
  ...
  fieldInput: { backgroundColor: theme.color.card, color: theme.color.onRed, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, borderWidth: 1, borderColor: theme.color.border },
  ...
  notesInput: { minHeight: 60, backgroundColor: theme.color.card, color: theme.color.onRed, borderRadius: 8, padding: 10, borderWidth: 1, borderColor: theme.color.border, marginBottom: 12, textAlignVertical: "top" },
  ...
  pickerSearch: { margin: 10, padding: 10, backgroundColor: theme.color.card, color: theme.color.onRed, borderRadius: 8, borderWidth: 1, borderColor: theme.color.border },
