...
const styles = StyleSheet.create({
  ...
  headerSub: { color: theme.color.textMuted, fontSize: 11, marginTop: 2, letterSpacing: 1 },
  ...
  blockH: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 2, marginBottom: 10 },
  ...
  generateBtnT: { color: "#fff", fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  hint: { color: theme.color.textMuted, fontSize: 11, fontStyle: "italic", marginBottom: 8 },
  summaryLine: { marginBottom: 8 },
  summaryKey: { color: theme.color.textDim, fontSize: 11, fontWeight: "900", letterSpacing: 1.2 },
  ...
  adjustArea: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  ...
  saveBtnT: { color: theme.color.brand, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
