...
const styles = StyleSheet.create({
  ...
  videoEyebrow: { color: "rgba(255,255,255,0.85)", fontSize: 9, fontWeight: "900", letterSpacing: 2 },
  ...
  playT: { color: "#fff", fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  ...
  fullReviewT: { color: "#fff", fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  icon: {
