...
const styles = StyleSheet.create({
  ...
  louisRole: { color: theme.color.textDim, fontSize: 11, fontWeight: "600" },
  ...
  queueReady: { color: theme.color.green || "#22c55e", fontSize: 11, fontWeight: "700", marginTop: 2 },
  queueError: { color: theme.color.brand, fontSize: 11, fontWeight: "700", marginTop: 2 },
