...
const styles = StyleSheet.create({
  ...
  roleText: { color: theme.color.brand, fontWeight: "800", letterSpacing: 1.5, fontSize: 11 },
  ...
  sectLabel: { color: theme.color.textMuted, fontSize: 11, letterSpacing: 2, fontWeight: "800" },
