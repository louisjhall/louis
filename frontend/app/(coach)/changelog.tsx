...
const styles = StyleSheet.create({
  ...
  dayHead: { color: theme.color.textDim, fontSize: 10, fontWeight: "800", letterSpacing: 1.5, marginBottom: 8 },
  ...
  cat: { fontSize: 9, fontWeight: "800", letterSpacing: 1.5 },
  actor: { color: theme.color.textDim, fontSize: 9, fontWeight: "800", letterSpacing: 1.5 },
  time: { color: theme.color.textDim, fontSize: 10, marginLeft: "auto" },
